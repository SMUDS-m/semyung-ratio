...
const BREAKDOWN = {
  at: "9/11 10:00",
  univ: {
    capIn: 1379, appIn: 4950, capOut: 80, appOut: 407,
    byType: [
      { name: "일반", cap: 803, app: 2591, outside: false },
      { name: "인문계고교", cap: 265, app: 963, outside: false },
      { name: "사회배려", cap: 26, app: 106, outside: false },
      { name: "지역인재", cap: 98, app: 404, outside: false },
      { name: "지역인재(기회)", cap: 4, app: 22, outside: false },
      { name: "특성화고교", cap: 57, app: 80, outside: false },
      { name: "면접우수", cap: 93, app: 509, outside: false },
      { name: "SMU의료", cap: 33, app: 275, outside: false },
      { name: "농어촌", cap: 35, app: 174, outside: true },
      { name: "특성화고(외)", cap: 10, app: 57, outside: true },
      { name: "기초생활", cap: 35, app: 176, outside: true }
    ]
  },
  depts: {
    "AI컴퓨터학부": [
      { name: "일반", cap: 42, capRaw: "42", app: 59, outside: false },
    ...
    "스마트IT학부": [
      { name: "일반", cap: 24, capRaw: "24", app: 15, outside: false },
    ...
    "전기전자공학과": [
      { name: "일반", cap: 25, capRaw: "25", app: 105, outside: false },
      { name: "인문계고교", cap: 5, capRaw: "5", app: 48, outside: false },
    ...
    "건축학과": [
      { name: "일반", cap: 35, capRaw: "35", app: 70, outside: false },
    ...
    "재난안전학과": [
      { name: "일반", cap: 20, capRaw: "20", app: 50, outside: false },
    ...
    "보건안전공학과": [
      ...
      { name: "지역인재", cap: 5, capRaw: "5", app: 12, outside: false },
