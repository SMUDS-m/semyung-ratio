...
const BREAKDOWN = {
  at: "9/11 11:00",
  univ: {
    capIn: 1379, appIn: 5047, capOut: 80, appOut: 414,
    byType: [
      { name: "일반", cap: 803, app: 2641, outside: false },
      { name: "인문계고교", cap: 265, app: 987, outside: false },
      { name: "사회배려", cap: 26, app: 107, outside: false },
      { name: "지역인재", cap: 98, app: 408, outside: false },
      { name: "지역인재(기회)", cap: 4, app: 22, outside: false },
      { name: "특성화고교", cap: 57, app: 80, outside: false },
      { name: "면접우수", cap: 93, app: 522, outside: false },
      { name: "SMU의료", cap: 33, app: 280, outside: false },
      { name: "농어촌", cap: 35, app: 176, outside: true },
      { name: "특성화고(외)", cap: 10, app: 58, outside: true },
      { name: "기초생활", cap: 35, app: 180, outside: true }
    ]
  },
  depts: {
    "AI컴퓨터학부": [
      { name: "일반", cap: 42, capRaw: "42", app: 59, outside: false },
      { name: "인문계고교", cap: 10, capRaw: "10", app: 18, outside: false },
    ...
    "전기전자공학과": [
      { name: "일반", cap: 25, capRaw: "25", app: 108, outside: false },
    ...
    "건축학과": [
      { name: "일반", cap: 35, capRaw: "35", app: 74, outside: false },
    ...
    "보건안전공학과": [
      { name: "일반", cap: 20, capRaw: "20", app: 41, outside: false },
