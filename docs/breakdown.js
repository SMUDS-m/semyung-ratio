...
const BREAKDOWN = {
  at: "9/10 23:40",
  univ: {
    capIn: 1379, appIn: 4518, capOut: 80, appOut: 380,
    byType: [
      { name: "일반", cap: 803, app: 2382, outside: false },
      { name: "인문계고교", cap: 265, app: 883, outside: false },
      { name: "사회배려", cap: 26, app: 95, outside: false },
      { name: "지역인재", cap: 98, app: 358, outside: false },
      { name: "지역인재(기회)", cap: 4, app: 21, outside: false },
      { name: "특성화고교", cap: 57, app: 73, outside: false },
      { name: "면접우수", cap: 93, app: 454, outside: false },
      { name: "SMU의료", cap: 33, app: 252, outside: false },
      { name: "농어촌", cap: 35, app: 167, outside: true },
      { name: "특성화고(외)", cap: 10, app: 57, outside: true },
      { name: "기초생활", cap: 35, app: 156, outside: true }
    ]
  },
  depts: {
    "AI컴퓨터학부": [
      { name: "일반", cap: 42, capRaw: "42", app: 57, outside: false },
      { name: "인문계고교", cap: 10, capRaw: "10", app: 15, outside: false },
    ...
    "스마트IT학부": [
      { name: "일반", cap: 24, capRaw: "24", app: 10, outside: false },
    ...
    "전기전자공학과": [
      { name: "일반", cap: 25, capRaw: "25", app: 96, outside: false },
    ...
    "건축학과": [
      { name: "일반", cap: 35, capRaw: "35", app: 64, outside: false },
    ...
    "재난안전학과": [
      { name: "일반", cap: 20, capRaw: "20", app: 45, outside: false },
    ...
    "보건안전공학과": [
      { name: "일반", cap: 20, capRaw: "20", app: 37, outside: false },
